...
Lemma~\ref{lem:spine} --- and every check agreed with what is reported here. The
program and its transcript are retained in an auxiliary archive and are
available on request; no part of the verification depends on them beyond what is
printed above.
