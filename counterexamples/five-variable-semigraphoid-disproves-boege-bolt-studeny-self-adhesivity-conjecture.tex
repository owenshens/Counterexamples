...
The ancillary file \texttt{verify\_selfadhesivity\_counterexample.py} uses
only the Python standard library and exact integer and rational arithmetic.
All computations above are also determined by the data printed here and are
