...
\]
The arXiv version of \cite{QuZang} states that the range
$8\le k\le20$ and $n\le10^4$ was checked before Conjecture~1.7 was
proposed; the pair $(k,n)=(10,13)$ lies in that range.  At $k=8$,
