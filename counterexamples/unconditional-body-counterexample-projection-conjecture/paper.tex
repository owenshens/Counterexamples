...
\medskip
\noindent\textit{Scope.}
The body $K_0$ is invariant under all coordinate sign changes, which is
precisely the hypothesis carried by \eqref{eq:conjecture}; it is, however,
neither an $\ell_q$-ball nor invariant under coordinate permutations. Thus the
example disproves Conjecture~3 as stated, but it does not address
Conjecture~2 of \cite{FMMN}, nor the variant of \eqref{eq:conjecture} in which
$K$ is required to be invariant under coordinate permutations as well as under
sign changes.
