...
\begin{remark}
Apart from three quoted inputs the argument above is self-contained, and
we isolate them here. Two are the M\"obius polynomials
$\mu_{K_3}(t)=2+5t+2t^2$ and $\mu_{P_3}(t)=1+3t+t^2$ of the weighted
bond posets of $K_3$ and $P_3$, and the multiplicativity
$\mu_{rX}=\mu_X^{\,r}$ over disjoint unions; these are Equation~(1.5)
and Proposition~2.2 of \cite{GDLW}, and it is they that identify the
polynomials $A$ and $B$ of the proof with $\mu_{K_3}$ and $\mu_{P_3}$.
The third is the reading of Conjecture~4.13(2) recorded above: it is
asserted there for arbitrary $k$, with no connectivity hypothesis, which
is what makes a disconnected pair admissible. Everything else --- the
identities $A-B=(1+t)^2$, $A^2-B^2=(1+t)^2(3+8t+3t^2)$ and
$A^3-B^3=(1+t)^2(7+37t+63t^2+37t^3+7t^4)$, the positivity of $Q_r$, and
the $\gamma$-expansion --- is polynomial algebra over $\mathbb{Z}$ which
the reader can carry out directly.
\end{remark}
