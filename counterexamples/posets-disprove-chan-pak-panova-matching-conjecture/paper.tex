...
\]
and conjectured that it has a matching saturating $W$; in the wording
of~\cite{CPP23}, that there exists a maximal matching covering all vertices
in $W$.
...
preprint version arXiv:2205.02798v3 [math.CO].
All section and conjecture numbers cited here refer to arXiv:2205.02798v3,
in which Conjecture~9.4 is stated in Section~9.12 (``Injections and matchings
for the Stanley inequality'') and the right action on words is set up in
Section~7; the journal version may number these differently.
