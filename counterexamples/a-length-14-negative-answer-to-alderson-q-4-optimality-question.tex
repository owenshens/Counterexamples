...
definitions of this note; all $66$ of its checks agree with the paper. The
...
search. The program and its transcript are retained in an auxiliary archive,
available on request; nothing above depends on them, since every quantity quoted is either
...
extendable and of additively maximal are taken from that paper. It does not
