...
$C_1$ and $C_2$ are \texttt{K?\textasciigrave CPagXAcAg} and
\texttt{K?\textasciigrave CPagPagEG}, in which the third character of each
is the ASCII grave accent, byte \texttt{60} hexadecimal.
