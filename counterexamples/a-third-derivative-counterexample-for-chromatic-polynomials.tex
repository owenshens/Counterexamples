...
program used for that re-run, together with its transcript, is retained in an
auxiliary archive and is available on request; it is not needed in order to
redo the calculation, since every input it consumed is printed above.
