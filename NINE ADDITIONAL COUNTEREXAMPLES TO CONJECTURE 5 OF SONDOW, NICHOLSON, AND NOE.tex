...
The accompanying dependency-free script \texttt{verify.py} constructs
$\pi(x)$ by a sieve through $172069$, recovers $R_1,\ldots,R_{5224}$
from \eqref{eq:lastbad}, verifies \eqref{eq:epsilon}, and checks all
$21803$ pairs in $\mathcal F$ using exact integer arithmetic.
