...
$R_2(H)\ge\max\{|V(H)|+3,10\}$~\cite{Liu}. Li and Wang improved this to
\[
...
Every verification above is finite and hand-sized, and each one is carried out
from the data printed in this paper: the six ordered nonzero differences of
...
$K_{2,4}$. All seventeen of these checks were recomputed a second time,
independently and from the printed residues alone, and every one agreed. No
