...
adjacency certificate in Section~1. A verification program that
recomputes the assertions of Theorem~\ref{thm:main} from that printed
table accompanies this paper; it reads no further data.
