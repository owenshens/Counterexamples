...
counts $16$ and $25$.  No data file or program accompanies this paper: every
quantity quoted above is either printed here or recomputable from the criteria
of Section~2 together with the definitions of \cite[Section~3]{CS}, and the
program used and its transcript are retained in an auxiliary archive,
available on request.  What a reader can and cannot check from the data
