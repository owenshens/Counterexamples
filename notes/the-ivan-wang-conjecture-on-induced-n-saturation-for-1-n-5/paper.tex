...
beyond the edge count of Lemma~\ref{lem:edgecount}. That second program and
the transcript of its run accompany this note; the first implementation is
not included here. The
specification above is what a reader should reimplement. An
