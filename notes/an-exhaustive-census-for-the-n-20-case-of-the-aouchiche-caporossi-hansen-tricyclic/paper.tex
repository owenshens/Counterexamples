...
\texttt{geng}. The program and its transcript accompany this note; no
claim made here depends on consulting them, since every check just
listed can be reproduced from the data printed in this paper.
