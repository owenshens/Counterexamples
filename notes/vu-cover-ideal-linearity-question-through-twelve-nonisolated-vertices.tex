...
re-derived. No source code accompanies this note, and none is required to
recheck it; the program and its transcript are retained in an auxiliary archive
available on request. The re-run is a second computation, not a proof.
