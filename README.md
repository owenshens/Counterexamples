...
**[OPEN_RESULTS.md](OPEN_RESULTS.md)** — the list: **85 papers refuting a published
conjecture or question**, **19 exhibiting an object whose existence was open**, and
**13 proving a conjecture or recording a note**. The 117 papers act on
...
|---|---|---|
| [`counterexamples/`](counterexamples/) | 85 | a published conjecture or question is refuted |
| [`constructions/`](constructions/) | 19 | an object whose existence was open is exhibited |
